...
**Verification**: The examples below include verification tasks. Tests are
OPTIONAL - include them when explicitly requested, when risk analysis selects
TDD, or when they are the smallest reliable evidence for a requirement. Every
generated task list must map changed requirements to an evidence class from
`AGENTS.md`.
...
> **NOTE**: If test-first evidence is selected, write those tests first and
> ensure they fail for the intended reason before implementation. If another
> evidence class is selected, record the exact command, artifact, or review
> check that proves the story.

- [ ] T010 [P] [US1] Contract test for [endpoint] in tests/contract/test_[name].py
- [ ] T011 [P] [US1] Integration test for [user journey] in tests/integration/test_[name].py
- [ ] T012 [P] [US1] Static or artifact check for [claim] using [command/artifact]
...
- [ ] TXXX [P] Additional verification evidence in tests/unit/ or reference artifacts
...
- Verification tasks should be completed before a story is claimed complete
- If test-first evidence is selected, those tests MUST fail for the intended
...
- Verify test-first tasks fail before implementing when TDD is the selected evidence
