...
- Default to a draft PR while iterating; mark ready only for the merge candidate. Draft pushes run the cheap deferred lane and cannot merge. See `docs/ci/ubicloud-cost-governance.md` "Operator Policy".
