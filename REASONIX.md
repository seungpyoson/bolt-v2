...
- **Python verification layer** — several lint/check commands go through `rust_verification.py` which wraps cargo; absolute-path cargo and toolchain-manager bypasses remain outside the accidental-use guard.
