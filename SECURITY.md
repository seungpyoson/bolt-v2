...
This project follows a "latest only" support model because it is a personal project.
...
Only the current `main` branch and the most recent release tag receive security updates.

## Reporting a Vulnerability

I use GitHub's built-in **private vulnerability reporting** (already enabled on this repository).
