...
pub fn write_backfill_conversion_completion_ledger_from_spec_file(
    ...
    let path_base = spec_path_resolution_base(spec_path, &spec.batch_plan_path);
    let batch_plan_path = resolve_spec_path(&path_base, &spec.batch_plan_path);
    ...
    let batch_execution_report = match &spec.batch_execution_report_path {
        Some(report_path) => {
            ...
            let resolved_report_path = resolve_spec_path(&path_base, report_path);
...
fn read_input(
    ...
    let resolved_publication_path = resolve_spec_path(path_base, &spec.publication_evidence_path);
    ...
    let resolved_mapping_path = resolve_spec_path(path_base, &spec.catalog_mapping_evaluation_path);
    ...
    let resolved_execution_plan_path = resolve_spec_path(path_base, &execution_plan_path);
