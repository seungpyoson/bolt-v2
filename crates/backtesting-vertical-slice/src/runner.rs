...
mod tests {
    ...
    use super::{
        ...
        CatalogEncodingConfig, CatalogMutationWitness, OperatorWorkBudgetGuard,
        OperatorWorkBudgetStage, SealedCatalogRoot, StrategyPreparationConfig,
        TrustedCatalogRootLease, apply_backtest_config_override, assert_read_back_matches,
        canonical_resolved_taker_config_bytes, capture_catalog_directory_identities,
        capture_catalog_file_identities, collect_sorted_cache_ids_guarded,
        ensure_settlement_currency_funded, expected_catalog_directories, expected_iterations,
        iterations_mismatch, load_bolt_v3_config, logical_catalog_hash_guarded,
        mint_local_catalog_run_view_authority_guarded, prepare_strategy_client_routes,
        raw_taker_config, render_debug_guarded, replay_executable_book_at_submission,
