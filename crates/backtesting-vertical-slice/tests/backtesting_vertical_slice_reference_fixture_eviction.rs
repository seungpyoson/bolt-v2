...
use crate::backtesting_vertical_slice_test_support::{
    ...
    BYBIT_OPERATOR_INPUTS_EVICTED_REFERENCE_PATHS, PHASE3_EVICTED_REFERENCE_PATHS,
...
use backtesting_vertical_slice::reference_fixture_index::{
    ...
    is_bybit_source_universe_operator_inputs_path, is_evicted_execution_pack_record_path,
...
fn bybit_operator_inputs_gitignore_pattern_matches_eviction_predicate() {
    ...
    let binance = "specs/023-nt-research-analytics-platform/reference/source-universe-operator-inputs/binance-hypothetical/operator-inputs/source-universe-operator-inputs.json";
