...
- invariant:
  - root risk authority for Bolt-owned strategy sizing is live now; NautilusTrader live risk-engine defaults are explicit in TOML and mapped into `LiveRiskEngineConfig` instead of inherited silently
- canonical owner:
