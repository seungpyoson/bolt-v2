...
- `qsize` must equal the pinned NT `LiveDataEngineConfig::default().qsize` value, verified as `100000` at pinned NT rev `a192a89f7a24e435cfba7a45b6dcd6de14622967`
...
| `qsize` | must equal the pinned NT `LiveDataEngineConfig::default().qsize` value, verified as `100000` at pinned NT rev `a192a89f7a24e435cfba7a45b6dcd6de14622967` | `LiveDataEngineConfig.qsize` |
...
- `snapshot_positions = false`
- `purge_from_database = false`
- `qsize` must equal the pinned NT `LiveExecEngineConfig::default().qsize` value, verified as `100000` at pinned NT rev `a192a89f7a24e435cfba7a45b6dcd6de14622967`
...
| `qsize` | must equal the pinned NT `LiveExecEngineConfig::default().qsize` value, verified as `100000` at pinned NT rev `a192a89f7a24e435cfba7a45b6dcd6de14622967` | `LiveExecEngineConfig.qsize` |
...
- must equal the pinned NT `LiveRiskEngineConfig::default().qsize` value, verified as `100000` at pinned NT rev `a192a89f7a24e435cfba7a45b6dcd6de14622967`
