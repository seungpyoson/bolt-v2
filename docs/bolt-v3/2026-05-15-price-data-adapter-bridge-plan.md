...
- Bolt-v3 client registration uses TOML `[clients.<id>]` keys as NT registration names, not fixed uppercase per-kind names; see `src/bolt_v3_client_registration.rs:83-125`.
