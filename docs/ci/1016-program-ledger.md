...
| ---: | --- | --- | --- |
| 1 | Issue-body and atomic-ruling reconciliation | `COMPLETE` | The reviewed live #1016 body now distinguishes already-landed Program-A deletions, the precursor-fixed legacy deletion manifest, freeze, and actual legacy deletion at atomic activation. Issue remains `OPEN`; live body SHA-256 `4c2c928e020090368b7c5825f74cc1fb3d4c53f4361f3ec6182b616f2c30575a`, updated `2026-07-12T13:52:42Z`; exact draft `/private/tmp/1016-d1-issue-body-draft.md`; audit `/private/tmp/1016-d1-issue-body-audit.md`; final live review `APPROVE` |
