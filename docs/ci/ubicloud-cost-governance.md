...
- Treat ready-PR full CI as high-cost evidence for the intended merge candidate, not a debug loop. Use draft iteration runs or diagnostic-only [`just rust-probe`](../../AGENTS.md#verification-and-merge) for mid-iteration feedback.
