...
This branch does not extend the process harness.

It freezes the protocol for deciding two separate questions:

1. should the current frozen harness snapshot be kept as a prototype
2. what would be required to scientifically validate a future harness run

## Exact Subject

- repo: `seungpyoson/bolt-v2`
- branch: `issue-208-process-validator`
- exact head: `c4d182d2482ec56e02e14be112359d285f7abece`

## Important Separation

The current subject head is only eligible for:
...
- the subject head was built before this protocol was frozen
- so a scientific claim on that head would still be retrospective
