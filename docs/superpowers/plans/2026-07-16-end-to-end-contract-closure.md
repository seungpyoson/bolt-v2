...
```bash
git add ci/rust-verification.toml scripts/verify_bolt_v3_evidence_novelty.py scripts/test_verify_bolt_v3_evidence_novelty.py src/bolt_v3_evidence_novelty_generated.rs
