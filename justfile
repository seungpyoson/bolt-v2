...
verify-bolt-v3-capital-admission-clamp-consumers: check-workspace
    python3 scripts/test_verify_bolt_v3_capital_admission_clamp_consumers.py
    python3 scripts/verify_bolt_v3_capital_admission_clamp_consumers.py
