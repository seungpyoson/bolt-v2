...
def test_migrates_v13_records_with_key_scoped_byte_preserving_replacements() -> None:
    ...
    assert migrated == [
        ...
        '{"schema_version":15,"recorded_at_utc_ns":1700000000000000002,"gate_id":"bolt_v3.submit_admission","kind":"admission_decision","payload":{"decision":{"notional":"0","economics_quote_id":"legacy-pre-v15-unavailable","economics_core_total":"0","economics_core_net_edge":"0","economics_core_edge_ratio":"0","economics_forecast_net_edge":"0","economics_forecast_complete":false,"economics_missing_forecast_component_ids":[],"economics_valid_until_ns":0,"economics_source_snapshot_ids":[],"outcome":"rejected_capital_admission","snapshot_source":"nt_capital_admission_state"},"note":"unchanged"}}',
