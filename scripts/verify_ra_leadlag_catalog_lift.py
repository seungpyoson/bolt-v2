...
TASK_RA007 = re.compile(r"^- \[[ xX]\] RA-007\b", re.MULTILINE)
...
def scan_root(root: Path) -> list[str]:
    ...
    elif not TASK_RA007.search(tasks.read_text(encoding="utf-8")):
        findings.append(f"{TASKS_PATH}: RA-007 task row is missing")
