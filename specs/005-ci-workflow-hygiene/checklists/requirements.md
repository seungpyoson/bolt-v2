...
- [x] CHK003 Is landed #332 topology represented as an active base invariant while #205 and #344 conditional requirements remain excluded until their workflow surfaces exist? [Completeness, Spec Edge Cases]
...
- [x] CHK008 Does the spec preserve #342 source-fence ordering and landed #332 shard/check-aarch64 topology without adding new sharding behavior? [Consistency, Spec FR-005, FR-012]
...
- [x] CHK017 Does the spec keep LiveNode-heavy nextest serialization out of #203 and treat it as already-owned by landed #332? [Boundary, Spec FR-012]
