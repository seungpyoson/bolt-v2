...
- **Minimal Slice Discipline**: PASS. The primary slice is #203. Residual #332/#195/#205/#344/#340 surfaces remain out of scope.
...
- `.config/nextest.toml` and LiveNode-heavy test serialization remain #332 scope.
