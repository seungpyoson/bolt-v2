...
**Rationale**: The live issue body maps nine child tracks with different owners and states. #70 is closed by investigation. #125 is a bolt-v2 incident anchor whose implementation continues in `claude-config`. #48 and #124 are investigation anchors whose forward implementation lives in #374 and #286. A single code PR claiming to close #123 would violate one-issue-one-PR scope discipline.
