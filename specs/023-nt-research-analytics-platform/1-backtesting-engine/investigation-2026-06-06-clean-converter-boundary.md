...
- Current BTE implementation audit after selecting that policy: the source-proof
  ...
  selector/result-contract binding and PMXT source-backed binary-option L2
  catalog projection using NT classes, not a venue-specific branch.
