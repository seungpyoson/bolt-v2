...
- Current BTE implementation audit after selecting that policy: the source-proof
  ...
  for `BinaryOption`, `OrderBookDelta`, and `TradeTick` fixture data. The next
  implementation gate is therefore PMXT source-backed binary-option L2 catalog
