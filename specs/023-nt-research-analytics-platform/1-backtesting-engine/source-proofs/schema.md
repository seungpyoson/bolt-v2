...
| `l2_evidence` | Required when claiming `L2_REPLAY`: the specific historical product (incremental deltas, or sufficient-cadence snapshots) + a dated coverage URL. A claim with no evidence is rejected. |
