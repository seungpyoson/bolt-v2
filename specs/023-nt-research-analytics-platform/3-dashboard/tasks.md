...
- [x] DASH-002 Define dashboard field-source matrix, including trade explanation fields, source proof id, run purpose, proof pin reason code/detail when present, fidelity class, claim limits, warning fields, source role, and data status/gap reason.
