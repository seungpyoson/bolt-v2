...
- [ ] DASH-010 Implement read-only source contract validation, including rejection of proof-strength reclassification, upstream proof acceptance, accepted proof mutation, forbidden-claim weakening, and historical-result relabeling after proof supersession.
