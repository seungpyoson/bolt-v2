...
- [ ] DASH-006 Record #369 as non-closure context for dashboard readiness.
- [ ] DASH-007 Define freshness rules plus source-role and data-status semantics; defer final user-facing label names and legend text to the shared terminology/legend registry.
