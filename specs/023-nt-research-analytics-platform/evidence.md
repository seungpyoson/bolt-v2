...
- `GitHub issues`: fetched/refreshed 2026-05-20 with `gh issue view`/`gh issue list` from
  ...
  #22, #23, #24, #34, #36, #39, #77, #112, #115, #148, #236, and #409.
...
| FR-016 TOML/NT config, SSM live secrets, no hardcoded venue identity | E-026, E-027 | SOURCE_PROVEN repo rule and constitution boundary; manifest proof pending |
