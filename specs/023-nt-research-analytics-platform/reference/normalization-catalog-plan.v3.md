...
v3 keeps the v2 design that the review did not challenge (the F1–F15 resolutions are all retained) and integrates the six-model review synthesis (`normalization-catalog-plan.v2-review-synthesis.md`). Every NT/object_store assertion below quotes the function at file:line at the pinned rev; no hand-waving. The changes:
