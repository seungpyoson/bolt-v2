...
Current local WIP evidence from the metadata-response probe against ignored operational `config/live.local.toml`:
...
- `operator-artifacts collect-data-client-behavior-probe-events-source --config config/live.local.toml --client-key polymarket_main --output /private/tmp/bolt-v2-t043a-metadata-response-v2/polymarket-behavior-probe-events.jsonl` passed read-only/no-submit and wrote sha256 `97618ae4fccd60c72f819810161f96506976853b9f501c0085f469836b9bace3`. The JSONL has 11 events: 1 metadata event and 10 quote events, with `max_age = 0`, `max_latency = 0`, and `max_skew = 2091`.
- Current-config Polymarket policy source: `/private/tmp/bolt-v2-t043a-metadata-response-v2/polymarket-policy-source-current.json`, sha256 `b8f322124948c5d7ade3a617f888149c60583e4660b586f1b4da2f63a25e2bda`.
- Current-config Polymarket behavior observation source: `/private/tmp/bolt-v2-t043a-metadata-response-v2/polymarket-behavior-observation-source.json`, sha256 `7869b923dc95993a19622cf81b0ebfa2fcf82b0359910e15789745a55fea686c`.
- Current-config Polymarket behavior observation: `/private/tmp/bolt-v2-t043a-metadata-response-v2/polymarket-behavior-observation.json`, sha256 `27a6a496f09811411656af74c2cf4faed9a44e6255b9d80da16dfd09fea6228d`; `behavior_observation_complete = true`, `missing_behavior_proofs = []`, `metadata_sample_count = 1`, and `quote_sample_count = 10`.
- Current-config matrix: `/private/tmp/bolt-v2-t043a-current-live-v2/data-client-production-readiness-matrix.json`, sha256 `70bd3d7ab0f2f78749f7a3c854e1636bef7dabfa72e76881006cf4cf8b93eb78`. It records 11 clients, 1 production-usable row (`POLYMARKET`), and 10 non-production-usable rows still missing `behavior_observation`.
