...
- [ ] T004 Send `specs/024-production-trade-readiness/{spec.md,plan.md,tasks.md,evidence.md,external-tasklist-review.md,scope-resolution.md}` to Claude, Gemini, DeepSeek, GLM, Kimi, and Grok for task-list review only; record verdicts in `specs/024-production-trade-readiness/external-tasklist-review.md`.
...
- [ ] T025 [P] [US4] Add RED tests for NT accepted and venue pending abort collectors in `tests/bolt_v3_operator_artifacts.rs`.
- [ ] T026 [US4] Implement NT accepted and venue pending abort collectors in `src/bolt_v3_operator_artifacts.rs`.
