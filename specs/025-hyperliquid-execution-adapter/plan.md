...
- PASS - Live trading fail-closed: live submit paths remain disabled until exact product proof, fee/rate policy reconciliation, any remaining product routing, and approval artifacts pass.
