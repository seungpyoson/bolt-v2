...
- Production `build_bolt_v3_live_node` consumes Hyperliquid approval artifacts through the provider binding and persists `used_at`; no-submit and all-configured mapping paths do not spend approvals.
