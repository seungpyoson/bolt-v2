...
- Live-submit approval artifacts bind configured product-submit proof artifact path and sha256.
...
- Product-submit proof files and live-submit approval files are read under separate TOML-owned byte caps before one-time approval consumption.
