...
**Implementation head before final evidence commit**: `ebd1a09d790ee6b242a9de49189bcfb7e361dd6e`
...
- Raw event preservation, audit-only raw access, and strategy-safe indexed IV products.
...
- Live-node IV lifecycle planning through `IvEngineLifecyclePlan` and `plan_iv_engine_lifecycle`.
...
- Internal review: complete; no blocking findings remain after fixes.
