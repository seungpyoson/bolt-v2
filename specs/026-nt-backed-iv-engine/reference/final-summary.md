...
- TOML-owned IV numeric bounds at ingestion and projection boundaries: `IvProfile.input_bounds` gates indexed NT/custom IV values, and `IvProjectionPolicy.output_bounds` gates computed projected scalar IV.
