...
- Validate surface IDs, source IDs, client references, instrument bindings, source classes, sample kinds, horizon policies, and aggregation settings.
...
- Unknown source route: bounded diagnostic counter, no unbounded memory growth.
