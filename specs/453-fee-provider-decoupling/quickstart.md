...
Run the Phase 2 red confirmations before production edits:
...
cargo test --test bolt_v3_strategy_registration fee_provider_resolution -- --nocapture
cargo test --test bolt_v3_strategy_registration fee_provider_source_fence_blocks_concrete_provider_in_shared_layers -- --nocapture
cargo test --test bolt_v3_strategy_registration sentinel_secret -- --nocapture
