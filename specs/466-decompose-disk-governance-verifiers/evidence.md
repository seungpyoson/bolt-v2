...
| Item 3 renamed cargo/rustc divergence | Same test pins runtime/static `rustup` classification and filesystem symlink classification differences for cargo/rustc-like paths. | Verified by fresh command-understanding pass. |
