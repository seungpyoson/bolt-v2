...
Evaluate whether Bolt may admit new risk using only fresh NT-derived loss/equity facts and configured policy thresholds, and enforce the decision at the shared submit-admission boundary.
...
The live runner subscribes to NT portfolio snapshot and position event topics for the configured account. The feed derives:
