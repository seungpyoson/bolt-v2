...
**Independent Test**: Submit-admission and live-node tests prove missing/breached loss snapshots reject new risk before NT submit, risk-reducing exits remain possible under existing caps, and live builds carry policy into submit admission.
