...
- reject compiled-order evidence that does not match configured venue, product kind, or collateral currency;
...
- NT open-order/fill/cancel/reject lifecycle events update reservations;
