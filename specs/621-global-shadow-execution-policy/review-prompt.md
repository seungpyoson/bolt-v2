...
4. Can shadow mode still mutate venue state through strategy-originated NT mutation APIs, source-fence gaps, or NT-managed paths not covered by the plan?
...
8. Are the TDD, source-fence, and verification tasks sufficient to prove the invariant at current repo standards?
