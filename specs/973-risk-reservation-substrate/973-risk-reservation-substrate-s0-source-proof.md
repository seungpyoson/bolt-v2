...
- NT feeds: `src/bolt_v3_position_sizer_runtime_feed.rs` is the existing consolidated NT-derived feed for order, account, portfolio, and position events. S0 reuses that feed surface; later slices connect logic to it.
