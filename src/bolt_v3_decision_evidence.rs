...
pub struct BoltV3AdmissionDecisionEvidence {
    ...
    pub instrument_id: String,
    pub notional: String,
    pub economics_quote_id: String,
    pub economics_core_total: String,
    pub economics_core_net_edge: String,
    pub economics_core_edge_ratio: String,
    pub economics_forecast_net_edge: String,
    pub economics_forecast_complete: bool,
    pub economics_missing_forecast_component_ids: Vec<String>,
    pub economics_valid_until_ns: u64,
    pub economics_source_snapshot_ids: Vec<String>,
    ...
    fn encode_admission_decision_line_wraps_decision_with_metadata() {
        for outcome in [
            ...
            let decision = BoltV3AdmissionDecisionEvidence {
                ...
                economics_core_edge_ratio: "0.04".to_string(),
