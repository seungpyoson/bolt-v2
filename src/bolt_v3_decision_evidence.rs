...
pub struct BoltV3ExitDecisionEvidence {
    ...
    pub rv_snapshot_blockers: Option<Vec<BoltV3ExitRvSnapshotBlocker>>,
    pub rv_source_diagnostics: Option<Vec<BoltV3RealizedVolatilitySourceDiagnosticEvidence>>,
...
impl<'de> Deserialize<'de> for BoltV3ExitDecisionEvidence {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        Ok(Self {
            ...
            rv_snapshot_blockers: Some(wire.rv_snapshot_blockers),
            rv_source_diagnostics: Some(wire.rv_source_diagnostics),
