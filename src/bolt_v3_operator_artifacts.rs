...
pub fn write_pre_run_clob_v2_adapter_signing_source_artifact_from_nt_signing_source(
    ...
    let source = collect_clob_v2_adapter_signing_source_from_nt_signing_source(
        &release_manifest,
        clob_signing_source,
    )?;
...
fn collect_clob_v2_adapter_signing_source_from_nt_signing_source(
    release_manifest: &Phase8PreRunReleaseManifestSourceProof,
    clob_signing_source: &str,
) -> Result<Phase8PreRunClobV2AdapterSigningSourceEvidence, BoltV3OperatorArtifactError> {
    let domain_requirements_sha256 =
        clob_v2_adapter_signing_domain_requirements_sha256(release_manifest, clob_signing_source)?;
    let signer = generate_ephemeral_clob_v2_adapter_signer()?;
    let signer_address = format!("{:#x}", signer.address());
    let seed = clob_v2_adapter_signing_probe_seed(release_manifest);
    ...
    let signed_order_fixture = ClobV2AdapterSigningSignedOrderFixture {
        ...
        record_kind: PRE_RUN_CLOB_V2_ADAPTER_SIGNING_SIGNED_ORDER_FIXTURE_RECORD_KIND,
    ...
    let signature_verification = ClobV2AdapterSigningSignatureVerification {
        schema_version: PRE_RUN_CLOB_V2_ADAPTER_SIGNING_SOURCE_SCHEMA_VERSION,
        record_kind: PRE_RUN_CLOB_V2_ADAPTER_SIGNING_SIGNATURE_VERIFICATION_RECORD_KIND,
        clob_signing_version: &release_manifest.clob_signing_version,
    ...
    Ok(Phase8PreRunClobV2AdapterSigningSourceEvidence {
        schema_version: PRE_RUN_CLOB_V2_ADAPTER_SIGNING_SOURCE_SCHEMA_VERSION,
        record_kind: PRE_RUN_CLOB_V2_ADAPTER_SIGNING_SOURCE_RECORD_KIND.to_string(),
        clob_signing_version: release_manifest.clob_signing_version.clone(),
        adapter_signing_source_sha256: release_manifest.clob_signing_source_sha256.clone(),
...
fn clob_v2_adapter_signing_domain_requirements_sha256(
    ...
    require_clob_v2_adapter_signing_source_marker(source, "DOMAIN_VERSION", "domain_version")?;
    require_clob_v2_adapter_signing_source_marker(source, "DOMAIN_NAME", "domain_name")?;
    require_clob_v2_adapter_signing_source_marker(source, "POLYGON_CHAIN_ID", "polygon_chain_id")?;
    require_clob_v2_adapter_signing_source_marker(source, "CTF_EXCHANGE", "ctf_exchange")?;
    require_clob_v2_adapter_signing_source_marker(
        source,
        "NEG_RISK_CTF_EXCHANGE",
        "neg_risk_ctf_exchange",
    )?;
    require_clob_v2_adapter_signing_source_marker(source, "OrderSigner", "order_signer")?;
    require_clob_v2_adapter_signing_source_marker(source, "sign_order", "sign_order")?;
    require_clob_v2_adapter_signing_source_marker(source, "order_hash", "order_hash")?;

    let proof = ClobV2AdapterSigningDomainRequirementsProof {
        schema_version: PRE_RUN_CLOB_V2_ADAPTER_SIGNING_SOURCE_SCHEMA_VERSION,
        record_kind: PRE_RUN_CLOB_V2_ADAPTER_SIGNING_DOMAIN_REQUIREMENTS_RECORD_KIND,
        clob_signing_version: &release_manifest.clob_signing_version,
...
fn generate_ephemeral_clob_v2_adapter_signer() -> Result<OrderSigner, BoltV3OperatorArtifactError> {
    let mut key_bytes = [u8::default(); CLOB_V2_ADAPTER_SIGNING_SEED_BYTES];
...
fn clob_v2_adapter_signing_probe_seed(
    ...
    hasher.update(release_manifest.clob_signing_version.as_bytes());
    hasher.update(release_manifest.clob_signing_source_sha256.as_bytes());
...
fn clob_v2_adapter_signing_token_id(seed: &[u8; CLOB_V2_ADAPTER_SIGNING_SEED_BYTES]) -> String {
    let mut bytes = [u8::default(); CLOB_V2_ADAPTER_SIGNING_U128_BYTES];
...
fn clob_v2_adapter_signing_seed_u64(
    ...
    let mut bytes = [u8::default(); CLOB_V2_ADAPTER_SIGNING_U64_BYTES];
