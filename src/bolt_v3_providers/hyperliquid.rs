...
pub use economics::{
    ...
    HyperliquidEconomicsConfig, HyperliquidEconomicsError, HyperliquidPerpetualSnapshotInput,
...
fn map_data(
    ...
    Ok(HyperliquidDataClientConfig {
        ...
        stale_stream_receive_timeout_secs: cfg.stale_stream_receive_timeout_secs,
        stream_health_check_interval_secs: cfg.stream_health_check_interval_secs,
        stale_stream_warning_cooldown_secs: cfg.stale_stream_warning_cooldown_secs,
        stale_stream_recovery_enabled: cfg.stale_stream_recovery_enabled,
        stale_stream_recovery_cooldown_secs: cfg.stale_stream_recovery_cooldown_secs,
        stale_stream_max_targeted_resubscribes: cfg.stale_stream_max_targeted_resubscribes,
