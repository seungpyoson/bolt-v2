    ...
    pub fn admit_at(
        ...
        if evaluation.outcome == BoltV3AdmissionOutcome::Admitted {
            let apply_counters = || -> Option<(u32, u32, u32, Option<String>, BoltV3SubmitAdmissionCounterRollback)> {
                ...
                let forced_reduction_order_count_before = inner.live_kill_switch_forced_reduction_order_count;
            ...
            if let Some(update) = apply_counters() {
                admitted_counter_update = Some(update);
            } else {
