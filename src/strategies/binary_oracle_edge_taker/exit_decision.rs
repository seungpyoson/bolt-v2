...
pub(super) struct ExitRealizedVolatilityGateReceipt {
    ...
    pub(super) raw_snapshot_blockers: Option<Vec<RealizedVolBlockReason>>,
    pub(super) source_diagnostics: Option<Vec<BoltV3RealizedVolatilitySourceDiagnosticEvidence>>,
...
pub(super) struct ExitEvaluationLogFields {
    ...
    pub(super) rv_snapshot_blockers: Option<Vec<BoltV3ExitRvSnapshotBlocker>>,
    pub(super) rv_source_diagnostics: Option<Vec<BoltV3RealizedVolatilitySourceDiagnosticEvidence>>,
...
mod tests {
    ...
    fn exit_decision_evidence_preserves_observed_inputs_from_log_fields() {
        let fields = ExitEvaluationLogFields {
            ...
            rv_snapshot_blockers: Some(Vec::new()),
