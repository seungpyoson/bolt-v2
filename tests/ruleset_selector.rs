...
fn exposes_tag_mismatch_rejection() {
    ...
    let candidates = vec![CandidateMarket {
        ...
        condition_id: "market-wrong-tag-condition".to_string(),
        up_token_id: "market-wrong-tag-up".to_string(),
        down_token_id: "market-wrong-tag-down".to_string(),
        start_ts_ms: Some(1_744_444_800_000),
...
fn uses_first_matching_reject_reason_for_multi_failure_candidate() {
    ...
    let candidates = vec![CandidateMarket {
        ...
        condition_id: "market-many-failures-condition".to_string(),
        up_token_id: "market-many-failures-up".to_string(),
        down_token_id: "market-many-failures-down".to_string(),
        start_ts_ms: Some(1_744_444_800_000),
        tag_slug: "bitcoin".to_string(),
...
fn returns_idle_when_no_market_is_eligible() {
    ...
    let candidates = vec![
        CandidateMarket {
            ...
            condition_id: "market-orders-closed-condition".to_string(),
            up_token_id: "market-orders-closed-up".to_string(),
            down_token_id: "market-orders-closed-down".to_string(),
            start_ts_ms: Some(1_744_444_800_000),
            tag_slug: "bitcoin".to_string(),
            declared_resolution_basis: binance_btcusdt_1m(),
            accepting_orders: false,
